...
@ManagedBean
@ViewScoped
public class ConsulterAutreDemandeBean {
	...
	public void init(){
		...
		demandesTraiter = demandeService.getAllAutreDemandeTraiter();
		demandes = demandeService.getAllAutreDemandeEnAttentes();
	...
	demandeService.rejectAutreDemande(demandeId,idManager);

	this.init();
	
	return "/pages/manager/ConsulterAutreDemande?faces-redirect=true";
	...
	public String acceptDemande(int demandeId)
	{
		...
		demandeService.acceptAutreDemande(demandeId,idManager);
