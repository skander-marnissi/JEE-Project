...
@ManagedBean
@ViewScoped
public class ConsulterDemandeRemboursementBean {
	...
	public void init(){
		...
		demandes = demandeService.getAllDemandeDeRemboursementEnAttentes();
	...
	public String rejectDemande(int demandeId)
	{
		
	
	demandeService.rejectDemandeDeRemboursement(demandeId,idFinancier);

	this.init();

	FacesContext.getCurrentInstance().addMessage("form:btn", new FacesMessage("Demande rejetée !"));
	
	return "/pages/financier/ConsulterDemandeRemboursement?faces-redirect=true";
	...
	public String acceptDemande(int demandeId)
	{
		
		demandeService.acceptDemandeDeRemboursement(demandeId,idFinancier);
		
		this.init();
		
		FacesContext.getCurrentInstance().addMessage("form:btn2", new FacesMessage("Demande acceptée !"));
